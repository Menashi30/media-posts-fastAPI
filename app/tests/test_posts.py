...
def test_get_one_does_not_exist_posts(authorized_client, test_posts) :
...
def test_delete_post_successfull(authorized_client, test_user, test_posts) :
    res = authorized_client.delete(f"/posts/{test_posts[0].id}")
    assert res.status_code == 204

def test_delete_post_doesnot_exist(authorized_client, test_user, test_posts) :
